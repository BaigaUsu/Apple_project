...
export function Ipad() {
    ...
    const [selectedCapacityIndex, setSelectedCapacityIndex] = useState(null);
    ...
    const handleBothClick = (index) => {
        ...
        handleCapClick(index); // Вызываем функцию для изменения цены
    };
                        ...
                        <div className={classes.Info__Block_Item}>Цвет
                            <div className={classes.Item__info}>
                               {icons.map((icon, index) => (
                                    ...
                                    src={icon}
                                    alt={`Color ${index + 1}`}
                                    className={selectedColorIndex === index ? classes.SelectedCapacity : 'img'}
                        ...
                        <div className={classes.Info__Block_Item}>Память
                            <div className={classes.Item__info}>
                                {capacity.map((capacity, index) => (
                                    <div key={index}
                                        className={selectedCapacityIndex === index ? classes.SelectedCapacity : 'div'}
